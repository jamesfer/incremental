...
var renderers = ['incremental', 'incrementalTracked', 'react'];
var counts = [
    [3, 2],
    [3, 3],
    [10, 2],
...
function attachBenchmarkListener(id, callback) {
    var _this = this;
    var button = Object(_utils__WEBPACK_IMPORTED_MODULE_1__["requireElement"])(id);
    button.addEventListener('click', function () { return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, void 0, function () {
...
//   });
// }
function generateChildCounts() {
    var _a;
    var childCounts = Array(20).fill(0).map(function (_, i) { return i + 2; });
    var childDepths = Array(20).fill(0).map(function (_, i) { return i + 2; });
    var counts = (_a = []).concat.apply(_a, childCounts.map(function (childCount) { return (childDepths.map(function (childDepth) { return ({
        childCount: childCount,
        childDepth: childDepth,
        leaves: Math.pow(childCount, childDepth),
        total: Array(childDepth).fill(0).map(function (_, i) { return Math.pow(childCount, (i + 1)); }).reduce(function (a, b) { return a + b; }) + 1,
    }); }).filter(function (_a) {
        var total = _a.total;
        return total <= 1024;
    })); }));
    counts.sort(function (a, b) { return a.total - b.total; });
    return counts;
}
window.generateChildCounts = generateChildCounts;
