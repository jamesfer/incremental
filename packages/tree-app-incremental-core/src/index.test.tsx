import { App } from 'incremental';
import { Store, createElement } from 'incremental';
import root from './Root';
import { State } from './state';
import { getByText, queryByText } from '@testing-library/dom';

function defer(fn?: () => void | Promise<void>): Promise<void> {
...
describe('TreeApp (incremental)', () => {
  function renderApp(state: State) {
    ...
    const app = new App(document.body, <Root />);
    app.start();
    store.attach(app);
    return { app, store };
  }
